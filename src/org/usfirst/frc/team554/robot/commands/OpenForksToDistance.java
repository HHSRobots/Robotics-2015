 ...
 *
 */
public class OpenForksToDistance extends Command {

	private double TargetDistance;

    public OpenForksToDistance(double TargetDistance) {
    ...
    protected void execute() {
    	...
    	remainingDist = Robot.fork.getDistanceBetweenForks()/2.;
    ...
    protected boolean isFinished() {
    	return ((Robot.fork.getDistanceBetweenForks() >= TargetDistance) ||
    	      Robot.fork.atLeftOutLimit() || Robot.fork.atRightOutLimit());
    }
