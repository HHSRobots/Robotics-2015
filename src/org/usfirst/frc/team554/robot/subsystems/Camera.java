...
public class Camera extends Subsystem {
    ...
    public Camera(){
        ...
        camSide = NIVision.IMAQdxOpenCamera("cam1", NIVision.IMAQdxCameraControlMode.CameraControlModeController);
        curCam = camFront;
	...
	public void cameraSide(){
		changeDone = false;
		NIVision.IMAQdxStopAcquisition(curCam);
    	NIVision.IMAQdxConfigureGrab(camSide);
    	NIVision.IMAQdxStartAcquisition(camSide);
    	curCam = camSide;
    	updateCam();
    	changeDone = true;
	}
